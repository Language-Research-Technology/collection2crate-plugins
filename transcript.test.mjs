...
const doc = (turns) => [
  "\tTranscript: demo", "",
  "Speakers:",
  "D:\tDamien [Damien Leung] (Australian, male) #damien",
  "S:\tStella [Tinxu Zhang] (Chinese, female) #stella",
  "C:\tChester (research assistant) #chester", "",
...
await check("an unnumbered transcript parses its turns and sections", async () => {
  ...
  assert.deepEqual(rows.map((r) => r.speakerID), ["#chester", "#damien", "#stella", "#stella"]);
});
